...
import com.googlecode.jobop.connector.component.JobopConsumerComponent;
import com.googlecode.jobop.connector.component.JobopConsumerComponentWrapper;
 ...
 * 
 */
public class ConsumerBeanDefinitionParser extends AbstractBeanDefinitionParser<JobopConsumerComponent> {
	...
	protected BeanDefinition extraParse(BeanDefinition curDefinition, Element element, ParserContext parserContext) {
		...
		// 註冊包裝bean
		RootBeanDefinition wrapperBeanDefinition = new RootBeanDefinition(JobopConsumerComponentWrapper.class);
	...
	@Override
	protected Class<JobopConsumerComponent> getBeanClazz() {
		return JobopConsumerComponent.class;
	}
